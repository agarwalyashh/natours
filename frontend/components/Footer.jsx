...
function Footer() {
  return (
    <footer className="flex justify-center sm:justify-between items-center px-4 py-2 md:py-4 md:px-6 m-2 text-xs sm:text-sm lg:text-[16px] absolute -bottom-20 w-full">
